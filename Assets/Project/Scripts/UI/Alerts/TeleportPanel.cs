...
namespace UI.Alerts
{
    public class TeleportPanel : MonoBehaviour
    {
        ...
        {
            _publishHandler.ViewVideoAds(_container.Instantiate<PlayingState>(), _indexAdsTeleportActivate);
        }
        ...
        {
            _publishHandler.ViewVideoAds(_container.Instantiate<PlayingState>(), _indexAdsTeleport);
        }
